...
PARAM$lgb_semilla  <- 794471   #cambiar por su propia semilla
...
PARAM$bo_lgb <- makeParamSet(
  ...
  makeNumericParam("lamda_l1",    lower=    0.3, upper=     0.8),
  makeNumericParam("lamda_l2", lower=    0.5, upper=     1.0),
  makeNumericParam("bagging_fraction",    lower=    0.2, upper=     0.6)
)
